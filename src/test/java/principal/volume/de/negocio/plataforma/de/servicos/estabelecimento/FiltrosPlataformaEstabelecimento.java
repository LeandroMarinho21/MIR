...
public class FiltrosPlataformaEstabelecimento extends Filtros {
	...
	public void Inicializar() {
		...
		// Login
		login2(driver, links.get(20).getUrl());
		// Filtro
	...
	public void Encerramento() {
		...
		waitingElementBeClickableid(driver, "listViewDTO:0:dtoDesc");
