...
public class FiltrosPlataformaRedes {
	...
	public void Inicializar() {
		...
		driver.get("https://192.168.80.18:8081/mir.console/dashboard/service/deviceCapture.jsf");
		// Login
		filtros.login2();
		// Filtro
	...
	public void Encerramento() {
		...
		filtros.waitingElementBeClickableid("listViewDTO:0:deviceCaptureTpDesc");
