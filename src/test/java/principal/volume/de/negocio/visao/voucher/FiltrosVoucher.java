package principal.volume.de.negocio.visao.voucher;
...
public class FiltrosVoucher {
	...
	public void Encerramento() {
		...
		filtros.waitingElementBeClickableid("treeViewBTSubProductDTO_node_0");
...
///		waitingtoclickx("//div[contains(@class,'entity_ReasonCodeExternalNetwork')]");
///		clickx("//div[contains(@class,'entity_ReasonCodeExternalNetwork')]");
///		clickx("//div[43]/div[1]/div[1]");
