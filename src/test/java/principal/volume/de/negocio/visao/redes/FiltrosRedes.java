package principal.volume.de.negocio.visao.redes;
...
public class FiltrosRedes {
	...
	public void Inicializar() {
		...
		f.getUrl("https://192.168.80.18:8081/mir.console/pages/view/viewnet.jsf");
		/// Login
		f.loginPrivate();
		// Filtro
		f.waitToClickFilter();
	...
	public void Encerramento() {
		...
		f.verifyElementTable("listViewBTNetDTO:0:viewNetDesc");
	...
	public void TestCombos6() {
		...
		f.selectAll("//div[56]/div[1]/div[1]");
		f.waitToClickComboGrupoBandeira();
		f.filterComboGrupoBandeira();
		f.selectAll("//div[57]/div[1]/div[1]");
		}
}
