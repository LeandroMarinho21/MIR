package principal.volume.de.negocio.visao.codigo.servico;
...
public class FiltrosCodigoServico {
		...
		public void Inicializar() {
			...
			driver.get("https://192.168.80.18:8081/mir.console/pages/view/viewservicecode.jsf");
			// Login
			filtros.login2();
			// Filtro
		...
		public void Encerramento() {
			...
			filtros.waitingElementBeClickableid("listViewBTServiceCodeDTO:0:viewScDesc");
