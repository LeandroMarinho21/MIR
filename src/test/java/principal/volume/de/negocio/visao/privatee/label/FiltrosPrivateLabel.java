package principal.volume.de.negocio.visao.privatee.label;
...
public class FiltrosPrivateLabel {
	...
	public void Encerramento() {
		...
		filtros.waitingElementBeClickableid("listViewBTSubProductDTO:0:viewPrivateDesc");
...
///		waitingtoclickx("//div[contains(@class,'entity_WebSourceTransaction')]");
///		clickx("//div[contains(@class,'entity_WebSourceTransaction')]");
///		clickx("//div[42]/div[1]/div[1]");
		}
