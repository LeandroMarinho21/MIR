...
public class TestLikePOSremodeladas {
	/// TesteFiltros
	@Test
	public void TestFiltrosLike() {
		...
		{
			WebDriverWait wait = new WebDriverWait(driver, 30);
			wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#tabViewLayout\\:0\\:mainmenubar > ul > li:nth-child(4)")));
		}
		{
			WebElement element = driver.findElement(By.cssSelector("#tabViewLayout\\:0\\:mainmenubar > ul > li:nth-child(4)"));
			Actions builder = new Actions(driver);
			builder.moveToElement(element).perform();
		}
		/// Menu Private Label
		{
			driver.findElement(By.linkText("POS Operadoras Remodelada")).click();
		}
		{
			WebDriverWait wait = new WebDriverWait(driver, 30);
		...
		driver.findElement(By.id("btnConsult")).click();
		{
			WebDriverWait wait = new WebDriverWait(driver, 30);
			wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("dialogLoadbar")));
		}
		...
		/// Verificar se o texto esta presente na pagina
			String textoElement = driver.findElement(By.xpath("//*[@id=\"listViewOperadoraPosDTO_data\"]/tr/td")).getText();
