...
public class TestLikeRedes {
	...
	public void TestFiltrosLike() {
		...
		/// Menu Visão Voucher
		{
			driver.findElement(By.linkText("Visão - Redes")).click();
		}
		{
			WebDriverWait wait = new WebDriverWait(driver, 30);
		...
		}
		{
			/// Verificar se o texto esta presente na pagina
				String textoElement = driver.findElement(By.xpath("//*[@id=\"listViewBTNetDTO_data\"]/tr/td")).getText();
