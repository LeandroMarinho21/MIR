...
public class TestLikeEmissor {
	/// TesteFiltros
			...
			public void TestFiltrosLike() {
				...
				/// Menu Visão Emissor
				{
					driver.findElement(By.linkText("Visão - Emissor")).click();
				}
				{
					WebDriverWait wait = new WebDriverWait(driver, 30);
				...
				{
				driver.findElement(By.id("filterpanel_header")).click();
				driver.findElement(By.id("chkGroupBrand")).click();
				WebDriverWait wait = new WebDriverWait(driver, 30);
				wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("dialogLoadbar")));
				}
				{
				...
				driver.findElement(By.id("btnFilter2")).click();
				{
					WebDriverWait wait = new WebDriverWait(driver, 30);
					wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("dialogLoadbar")));
				}
				...
				/// Verificar se o texto esta presente na pagina
					String textoElement = driver.findElement(By.xpath("//*[@id=\"listViewBTIssuerDTO_data\"]/tr/td")).getText();
