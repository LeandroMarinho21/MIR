...
public class FiltrosVolumeHrHr extends Filtros {
	...
	public void TestCombos3() {
		...
		waitingtoclickx(driver, "//div[contains(@class,'entity_Region')]");
		clickx(driver, "//div[contains(@class,'entity_Region')]");
