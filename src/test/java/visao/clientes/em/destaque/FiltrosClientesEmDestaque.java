package visao.clientes.em.destaque;
...
public class FiltrosClientesEmDestaque extends Filtros {
	...
	public void Inicializar() {
		...
		// Login
		login2(driver, links.get(13).getUrl());
		// Filtro
	...
	public void Encerramento() {
		...
		waitingElementBeClickableid(driver, "listGroupEstablishmentPDVDTO:0:vgeDesc");
